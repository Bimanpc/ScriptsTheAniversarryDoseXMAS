...
:Syntax
ECHO.
ECHO CHMFixUNC-------------------------------OPA.bat,  Version OPA 2022
ECHO Allow *.chm files to be opened from currently mapped network drives
ECHO.
ECHO Usage:  CHMFIXUNC
ECHO.
ECHO Note:   This bath file sets following registry values:
ECHO.
ECHO         [HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\HTMLHelp\1.x\ItssRestrictions]
