...
:Syntax
ECHO.
ECHO BackupScheduledTasks.bat,  Version 2022
ECHO Backup and restore scheduled tasks in Task Scheduler's root 
ECHO.
...
ECHO.
ECHO Notes:  Only tasks in the Task Scheduler's root  will be backed up.
ECHO         Each scheduled task in the Task Scheduler's root  is saved as an
