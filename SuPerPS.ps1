...
Function fileBrowser
{
    try {
        ...
        $lineList.Title = "Select TEXT file."
        ...
        $totalServers = $totalServers.Count
            ...
            $hash.outputBox.Selectioncolor = "Green"
            Add-OutputBoxLine -Message "`r`nFile loaded. Click RUN."
            }
...
{
    $hash.Form.text = "GUI  by PS BILL PS PCTECHGREU $Version - Merry Christmas and a Happy New Year!"
...
$hash.serverBox.Font = 'Verdana,10'
...
{
        $hash.outputBox.AppendText("Your PowerShell  is $getPowerShellVersion. `nGUI Template is ready.")
}
else
{
        $hash.outputBox.Selectioncolor = "Red"
        $hash.outputBox.AppendText("Your PowerShell  is $getPowerShellVersion. `nGUI Template may not run correctly on your computer.")
}
...
$hash.buttonBrowse.Font = 'Verdana,10'
...
$hash.buttonRun.Font = 'Verdana,10'
